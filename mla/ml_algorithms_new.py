...
# Encode features for ML algorithms
...
def queryurl(var_url):
	...
	return queryalgorithms(x)

def queryalgorithms(var_set):
...
print queryurl("google.com")
print queryurl("www.itidea.it/centroesteticosothys/img/_notes/gum.exe")
